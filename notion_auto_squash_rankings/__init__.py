...
------------------
requests :
    HTTP requests needed to get the html of the pages to scrap and use the Notion API.
beautifulsoup4 :
    The scraping library used to get the information about the player's and their ranking.
"""